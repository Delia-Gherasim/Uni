            ...
            if (!(varValue.getType() instanceof RefType)) {
                ...
                if (!heap.isDefined(address)) {
                    ...
                    if (!exprValue.getType().equals(((RefType) varValue.getType()).getInner())) {
                        throw new ExceptionStatement("WriteHeap: "+exprValue.toString()+" Type mismatch between expression "+exprValue.getType()+"and variable location type "+((RefType) varValue.getType()).getInner());
                    } else {
