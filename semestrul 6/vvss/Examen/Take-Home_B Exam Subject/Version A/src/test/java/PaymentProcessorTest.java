...
public class PaymentProcessorTest {
    ...
    PaymentProcessor.PaymentMethod CreditMethod = PaymentProcessor.PaymentMethod.CREDIT_CARD;
    PaymentProcessor.PaymentMethod PaypalMethod = PaymentProcessor.PaymentMethod.PAYPAL;
    PaymentProcessor.PaymentMethod CashMethod = PaymentProcessor.PaymentMethod.CASH;
