...
public class Controller {
    ...
    List<ProgrState> removeCompletedPrg(List<ProgrState> inPrgList) {
    ...
    public void allStep() throws Exception {
        ...
        // List<ProgrState> prgList = removeCompletedPrg(repo.getPrgList());
    ...
    void unsafeGarbageCollector(List<ProgrState> prgList) {
